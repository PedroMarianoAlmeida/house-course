...
export default function HouseForm({ }: IProps) {
    ...
    const handleCreate = async (data: IFormData) => {
        const { data: signaureData } = await createSignature();
        if (signaureData) {
            const { signature, timestamp } = signaureData.createImageSignature;
        ...
        >
            ...
            {address && <>
                ...
                <div className="mt-4">
                    <label
                        htmlFor="image"
                        className="p-4 border-dashed border-4 borer-gray-600 block cursor-pointer"
                    >
                    ...
                    {previewImage && (
                        <img
                            ...
                            style={{ width: "576px", height: `${576 * 9 / 16}px` }}
                        />
                    )}
                ...
                <div className="mt-4">
                    ...
                    <input
                        ...
                        ref={register({
                            ...
                            max: { value: 10, message: "Woahh, too big o a house" },
