...
class HouseInput {
    ...
    @Field(_type => CoordenatesInput)
    coordinates!: CoordenatesInput;
    ...
    async createHouse(
        ...
        return await ctx.prisma.house.create({
            data: {
                ...
                badrooms: input.bedrooms, //I didn't find where I typed bAdrooms, when I realize I correct this    
            }
        })
    }
}
